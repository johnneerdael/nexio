...
type ParseRegex = {
  resolutions: Record<string, RegExp>
  qualities: Record<string, RegExp>
  visualTags: Record<string, RegExp>
  audioTags: Record<string, RegExp>
  audioChannels: Record<string, RegExp>
  languages: Record<string, RegExp>
  encodes: Record<string, RegExp>
  releaseGroup: RegExp
}

export const PARSE_REGEX: ParseRegex = {
  resolutions: {
