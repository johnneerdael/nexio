...
const imdbEnabled: boolean = settings.integrations.imdb.enabled
const imdbBaseUrl: string = settings.integrations.imdb.baseUrl
...
// @ts-expect-error Contract v3 moves synced home catalog settings out of layout.
settings.layout

// @ts-expect-error Contract v3 moves synced Trakt catalog settings under catalogs.trakt.
settings.trakt

// @ts-expect-error Contract v3 moves MDBList catalog selection state under catalogs.mdblist.
