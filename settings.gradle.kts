...
if (readUseMedia3SourceFlag()) {
    includeBuild("media") {
        dependencySubstitution {
            ...
            substitute(module("androidx.media3:media3-exoplayer-kodi-cpp-audiosink"))
                .using(project(":lib-exoplayer-kodi-cpp-audiosink"))
            ...
            substitute(module("androidx.media3:media3-decoder-ffmpeg"))
