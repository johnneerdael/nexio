...
""".trimIndent(),
        badgeRowTemplate = """{stream.visualTags::exists["{stream.visualTags::join(' ')::replace('Dolby Vision','[[icon:dovi:1.40]]')::replace('DoVi','[[icon:dovi:1.40]]')::replace('DV','[[icon:dovi:1.40]]')::replace('HDR10+','[[icon:hdr10plus:1.40]]')::replace('HDR10','[[icon:hdr10:1.40]]')::replace('HDR','[[icon:hdr10:1.40]]')::replace('HLG','[[icon:hlg:1.40]]')::replace('SDR','[[icon:sdr:1.40]]')::replace('AI','[[icon:ai:1.40]]')}"||""]} {stream.audioTags::exists["{stream.audioTags::join(' ')::replace('Atmos','[[icon:atmos:1.40]]')::replace('TrueHD','[[icon:truehd:1.40]]')::replace('DTS-HD MA','[[icon:dtshd:1.40]]')::replace('DTS:X','[[icon:dtsx:1.40]]')::replace('DD+','[[icon:ddp:1.40]]')::replace('DD','[[icon:dd:1.40]]')::replace('EAC3','[[icon:ddp:1.40]]')::replace('AC3','[[icon:dd:1.40]]')::replace('DTS','[[icon:dts:1.40]]')}"||""]}"""
    )
