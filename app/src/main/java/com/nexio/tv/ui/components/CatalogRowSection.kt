...
fun CatalogRowSection(
    ...
    trailerPreviewUserAgents: Map<String, String> = emptyMap(),
    trailerPreviewSigningClientKeys: Map<String, String> = emptyMap(),
    trailerPreviewStreamingDataPoTokens: Map<String, String> = emptyMap(),
    trailerPreviewCaptions: Map<String, List<com.nexio.tv.data.trailer.YouTubeCaptionTrack>> = emptyMap(),
    trailerPreviewExternalUrls: Map<String, String> = emptyMap(),
        ...
        LazyRow(
            ...
            itemsIndexed(
                ...
                ContentCard(
                    ...
                    trailerPreviewSigningClientKey = trailerPreviewSigningClientKeys[item.id],
                    trailerPreviewStreamingDataPoToken = trailerPreviewStreamingDataPoTokens[item.id],
                    trailerPreviewCaptions = trailerPreviewCaptions[item.id].orEmpty(),
