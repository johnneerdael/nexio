...
public final class RawImage extends Table {
  ...
  public static int createRawImage(FlatBufferBuilder builder,
      int dataOffset,
      int width,
      int height) {
  ...
  public static int endRawImage(FlatBufferBuilder builder) {
  ...
  public static final class Vector extends BaseVector {
    ...
    public RawImage get(int j) { return get(new RawImage(), j); }
    public RawImage get(RawImage obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
