...
class TraktMutationRoutingAuditTest {
    ...
    private companion object {
        ...
        private val expectedCallSiteCounts = sortedMapOf(
            ...
            "app/src/main/java/com/nexio/tv/data/repository/trakt/TraktProgressMutationExecutor.kt:addHistory" to 1,
            "app/src/main/java/com/nexio/tv/data/repository/trakt/TraktProgressHistoryMutationAdapter.kt:addHistory" to 1,
            "app/src/main/java/com/nexio/tv/data/repository/trakt/TraktProgressMutationExecutor.kt:deletePlayback" to 1,
            "app/src/main/java/com/nexio/tv/data/repository/trakt/TraktProgressHistoryMutationAdapter.kt:deletePlayback" to 1,
            "app/src/main/java/com/nexio/tv/data/repository/trakt/TraktProgressMutationExecutor.kt:removeHistory" to 1,
