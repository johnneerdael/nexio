...
class InlineIconTokenRegistryTest {
    ...
    fun `token registry resolves audio and visual inline badges`() {
        ...
        assertNotNull(InlineIconTokenRegistry.resolve("hdr10plus"))
        assertNotNull(InlineIconTokenRegistry.resolve("hlg"))
        assertNotNull(InlineIconTokenRegistry.resolve("sdr"))
        assertNotNull(InlineIconTokenRegistry.resolve("ai"))
        ...
        assertEquals(ScaleClass.INLINE, InlineIconTokenRegistry.resolve("hdr10plus")?.scaleClass)
        assertEquals(ScaleClass.INLINE, InlineIconTokenRegistry.resolve("hlg")?.scaleClass)
        assertEquals(ScaleClass.INLINE, InlineIconTokenRegistry.resolve("sdr")?.scaleClass)
        assertEquals(ScaleClass.INLINE, InlineIconTokenRegistry.resolve("ai")?.scaleClass)
