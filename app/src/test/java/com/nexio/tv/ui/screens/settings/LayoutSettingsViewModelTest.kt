...
class LayoutSettingsViewModelTest {
    ...
    private fun stubLayoutPreferences(
        ...
        every { layoutPreferenceDataStore.sidebarCollapsedByDefault } returns flowOf(false)
        every { layoutPreferenceDataStore.modernSidebarEnabled } returns flowOf(false)
        every { layoutPreferenceDataStore.modernSidebarBlurEnabled } returns flowOf(false)
