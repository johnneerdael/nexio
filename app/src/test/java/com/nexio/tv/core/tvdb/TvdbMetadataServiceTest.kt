...
class TvdbMetadataServiceTest {
    ...
    fun `poster ratings override replaces only poster`() = runTest {
        ...
        val service = TvdbMetadataService(tvdbApi, authService, posterResolver, cacheStore, TvdbSeasonOrderMapper())
    ...
    private fun tvdbService(tvdbApi: TvdbApi): TvdbMetadataService {
        ...
        return TvdbMetadataService(tvdbApi, authService, posterResolver, cacheStore, TvdbSeasonOrderMapper())
    }
