...
class AddonSyncCodecTest {
    ...
    private val torrentioRdSuffix =
        "/debridoptions=nodownloadlinks%7Crealdebrid=L7VSEJBKIQE52BW7NQMSJGYTP3IPDTLKR6RUBNF5GKNZ646G5ZRA/manifest.json"
    private val torrentioPmSuffix =
        "/debridoptions=nodownloadlinks%7Cpremiumize=szpwe4fx4ngs8u9q/manifest.json"
    ...
    @Test
    fun `parseStoredAddonInstallUrl handles bare origin from public manifest install`() {
