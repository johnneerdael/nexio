...
Generated: `2026-04-27T22:55:49.212753Z`
Git SHA: `d4da1ecaf`
Git worktree: `DIRTY` (5 changed files, 4 untracked)
...
| total in-scope endpoint shapes | 125 |
| total runtime-covered calls | 89 |
...
| planned-not-active endpoint shapes | 48 |
...
| TMDB | ACTIVE_RUNTIME_COVERED | yes | yes | yes | 15 | CacheFirst, Disabled, ObserveOnlyOrMutation | PASS |
...
| `trakt.calendar.shows` | TRAKT | `trakt-json-v2` | `TraktIntegrationProvider.fetchCalendarShows` | `accountOperationKey` | `accountCacheKey(session` | USER_VISIBLE | CacheFirst | `traktAuthService.executeAuthorizedRequestWithinRuntimeCall` | PASS |
| `trakt.trending.movies` | TRAKT | `trakt-json-v2` | `TraktIntegrationProvider.fetchTrendingMovies` | `accountOperationKey` | `accountCacheKey(session` | USER_VISIBLE | CacheFirst | `traktAuthService.executeAuthorizedRequestWithinRuntimeCall` | PASS |
| `trakt.trending.shows` | TRAKT | `trakt-json-v2` | `TraktIntegrationProvider.fetchTrendingShows` | `accountOperationKey` | `accountCacheKey(session` | USER_VISIBLE | CacheFirst | `traktAuthService.executeAuthorizedRequestWithinRuntimeCall` | PASS |
| `trakt.popular.movies` | TRAKT | `trakt-json-v2` | `TraktIntegrationProvider.fetchPopularMovies` | `accountOperationKey` | `accountCacheKey(session` | USER_VISIBLE | CacheFirst | `traktAuthService.executeAuthorizedRequestWithinRuntimeCall` | PASS |
| `trakt.popular.shows` | TRAKT | `trakt-json-v2` | `TraktIntegrationProvider.fetchPopularShows` | `accountOperationKey` | `accountCacheKey(session` | USER_VISIBLE | CacheFirst | `traktAuthService.executeAuthorizedRequestWithinRuntimeCall` | PASS |
| `trakt.recommended.shows` | TRAKT | `trakt-json-v2` | `TraktIntegrationProvider.fetchRecommendations` | `accountOperationKey` | `accountCacheKey(session` | USER_VISIBLE | CacheFirst | `traktAuthService.executeAuthorizedRequestWithinRuntimeCall` | PASS |
...
| `playback.opensubtitles_hash` | SUBTITLE_SOURCE_DOWNLOAD | Global | PLAYBACK_RESOLUTION | ObserveOnlyOrMutation | `` | 1 | provider/scope |
...
| `tmdb.person.detail` | `GET /person/{person_id}` | single-item enrichment | api-key-or-token | hash/redact credentials and URLs | `` | `` | PLANNED_NOT_ACTIVE |
| `tmdb.person.combined_credits` | `GET /person/{person_id}/combined_credits` | list batch | api-key-or-token | hash/redact credentials and URLs | `` | `` | PLANNED_NOT_ACTIVE |
...
| `tmdb.person.detail` | TMDB | no | PLANNED_NOT_ACTIVE | `` | no MetadataRouter blocker; classify as planned inventory until implemented |
| `tmdb.person.combined_credits` | TMDB | no | PLANNED_NOT_ACTIVE | `` | no MetadataRouter blocker; classify as planned inventory until implemented |
...
| `tmdb.person.detail` | TMDB | `primary-metadata-core-v1` | CacheFirst |  | 7d | 30d | Global | `` | PASS |
| `tmdb.person.combined_credits` | TMDB | `primary-metadata-core-v1` | CacheFirst |  | 7d | 30d | Global | `` | PASS |
...
| `tmdb.person.detail` | `provider, apiShapeId, operation_inputs, schema_version` | `raw Authorization token, raw API key, apiKey.hashCode` | `` | PASS |
| `tmdb.person.combined_credits` | `provider, apiShapeId, operation_inputs, schema_version` | `raw Authorization token, raw API key, apiKey.hashCode` | `` | PASS |
...
| `trakt.calendar.shows` | `provider, apiShapeId, operation_inputs, schema_version, accountHash` | `raw Authorization token, raw API key, apiKey.hashCode` | `accountCacheKey(session` | PASS |
| `trakt.trending.movies` | `provider, apiShapeId, operation_inputs, schema_version, accountHash` | `raw Authorization token, raw API key, apiKey.hashCode` | `accountCacheKey(session` | PASS |
| `trakt.trending.shows` | `provider, apiShapeId, operation_inputs, schema_version, accountHash` | `raw Authorization token, raw API key, apiKey.hashCode` | `accountCacheKey(session` | PASS |
| `trakt.popular.movies` | `provider, apiShapeId, operation_inputs, schema_version, accountHash` | `raw Authorization token, raw API key, apiKey.hashCode` | `accountCacheKey(session` | PASS |
| `trakt.popular.shows` | `provider, apiShapeId, operation_inputs, schema_version, accountHash` | `raw Authorization token, raw API key, apiKey.hashCode` | `accountCacheKey(session` | PASS |
| `trakt.recommended.shows` | `provider, apiShapeId, operation_inputs, schema_version, accountHash` | `raw Authorization token, raw API key, apiKey.hashCode` | `accountCacheKey(session` | PASS |
...
| `tmdb.person.detail` | TMDB | runtime-contract-baseline | WARN | shape has no active runtime spec |
| `tmdb.person.combined_credits` | TMDB | runtime-contract-baseline | WARN | shape has no active runtime spec |
