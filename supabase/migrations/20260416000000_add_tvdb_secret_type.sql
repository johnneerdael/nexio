-- Add tvdb_api_key to the account_secrets secret type constraint,
-- the sync RPC function whitelists, and the account settings
-- default payload / canonical extraction functions.
