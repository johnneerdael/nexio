-- Add tvdb integration fields to account settings default payload
-- and canonical extraction so integrations.tvdb.enabled survives
-- pull/push sync correctly.

-- Deploy the default payload with tvdb integration fields.
...
-- Deploy the canonical extraction with tvdb integration fields.
...
-- select public.account_settings_v2_default_payload()#>'{integrations,tvdb}';
-- select public.sync_pull_account_snapshot(6)->'settings'->'integrations' ? 'tvdb';
