...
## Task B.6: ❌ Escalated — Episode-mapping warmup is missing
...
## Task B.7: ❌ Escalated — Alias-id ambiguity guard is missing
...
## Task B.8: ❌ Escalated — Hidden-dropped filter silently bypassed
